...
* [ ] Verify image exists at `ghcr.io/syssentinel/agent-ts:latest`.
* [ ] **Important**: Go to GitHub Package Settings and change visibility to **Public**.

### **Phase 2: Distribution**

* [x] Update `install_agent.sh` to use the GHCR image.
* [ ] Host `install_agent.sh` on a public URL (e.g., GitHub Raw, S3, or Vercel).
* [ ] Update the curl command in this README with the final script URL.
